...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "crdt" '("add" "challenge" "contact" "crdt-" "cursor" "delete" "error" "fcap" "funcall" "get" "insert" "leave" "login" "overlay-" "process" "ready" "remove" "return" "sync" "var")))
